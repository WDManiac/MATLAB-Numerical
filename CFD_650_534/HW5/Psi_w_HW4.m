...
xlabel 'y'; ylabel 'u'; title 'u(y) at various locations for Re=1';
...
legend('x=0.25','x=0.5','x=0.75','Location','NorthWest')
set(gca,'FontSize',14); grid on;
xlabel 'y'; ylabel 'v'; title 'v(y) at various locations for Re=1';
...
set(gca,'FontSize',14); grid on;
xlabel 'y'; ylabel '\omega'; title '\omega(y) at various locations for Re=1';